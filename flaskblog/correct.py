...
def booking():
    ...
    if form.validate_on_submit():
        ...
        if d is None:
            ...
            print(date)
            book_info = BookingInfo(pickup=form.pickup.data,destination=form.destination.data,driver_email=d.email,date=date,user_id=current_user.id)
